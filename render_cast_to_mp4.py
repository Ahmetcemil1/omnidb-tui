...
def render_screen_to_image(screen, font, char_width=10, char_height=22, cols=120, rows=35):
    img_w = cols * char_width + 40
    img_h = rows * char_height + 40
...
def main():
    ...
    frame_count = 0
    print("📹 Rendering terminal frames to high-definition MP4...")
